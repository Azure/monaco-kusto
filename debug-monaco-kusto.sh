...
MONACO_KUSTO_PACKAGE_FOLDER="./package"
SOURCE_FOLDER="$MONACO_KUSTO_PACKAGE_FOLDER/release"
DESTINATION_FOLDER="$WEB_UX_FOLDER/node_modules/@kusto/monaco-kusto/release"

# Save the current directory
CURRENT_DIR=$(pwd)

# Step 1: Go to monaco-kusto/package and run 'yarn build'
cd "$MONACO_KUSTO_PACKAGE_FOLDER" || { echo "Failed to change directory to $MONACO_KUSTO_PACKAGE_FOLDER"; exit 1; }
