...
if (typeof document == 'undefined') {
    var basePath = "../../"
    if(self.MonacoEnvironment?.baseUrl) {
        basePath = self.MonacoEnvironment.baseUrl + "/vs/"
    }
    ...
    importScripts(
        basePath + 'language/kusto/bridge.min.js',
        basePath + 'language/kusto/kusto.javascript.client.min.js',
        basePath + 'language/kusto/newtonsoft.json.min.js',
        basePath + 'language/kusto/Kusto.Language.Bridge.min.js'
    );
}`;
